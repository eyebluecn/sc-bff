...
type RichSubscriptionDTO struct {
	//订阅本身
	Subscription *SubscriptionDTO `thrift:"subscription,1" form:"subscription" json:"subscription" query:"subscription"`
	//专栏
	Column *ColumnDTO `thrift:"column,2" form:"column" json:"column" query:"column"`
	//读者
	Reader *ReaderDTO `thrift:"reader,3" form:"reader" json:"reader" query:"reader"`
	//订单
	Order *OrderDTO `thrift:"order,4" form:"order" json:"order" query:"order"`
}
...
type RichColumnDTO struct {
	//专栏本身
	Column *ColumnDTO `thrift:"column,1" form:"column" json:"column" query:"column"`
	//关联的作者
	Author *AuthorDTO `thrift:"author,2" form:"author" json:"author" query:"author"`
	//关联的报价
	ColumnQuote *ColumnQuoteDTO `thrift:"columnQuote,3" form:"columnQuote" json:"columnQuote" query:"columnQuote"`
	//关联的订阅情况
	Subscription *SubscriptionDTO `thrift:"subscription,4" form:"subscription" json:"subscription" query:"subscription"`
}
