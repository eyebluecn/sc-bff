module github.com/eyebluecn/sc-bff
...
require (
	...
	github.com/eyebluecn/sc-misc-idl v0.0.0-20240601110441-7eef427929f7
	github.com/eyebluecn/sc-subscription-idl v0.0.0-20240602101656-5039cb5d3d7e
)
